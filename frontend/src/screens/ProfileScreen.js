...
export default function ProfileScreen(props){
    ...
    }, [dispatch, userInfo, user, successUpdate, setSellerDescription, setSellerLogo, setSellerName]);
                ...
                </div>
                {
                    ...
                    (
                        ...
                        <div>
                            ...
                            <input id="email" type="email" placeholder="Enter email" value={email} onChange={(e) => setEmail(e.target.value)} required disabled></input>
                        </div>
                        <div>
